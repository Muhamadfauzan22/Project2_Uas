...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form action="/backend/drakor/" method="post">
            @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    <input id="poster" name="poster" type="text" class="form-control" required>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    <input id="rating" name="rating" type="number" max="5" class="form-control" required>
                </div>
            </div>
            <div class="form-group row">
